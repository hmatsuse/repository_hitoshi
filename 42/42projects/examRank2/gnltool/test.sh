...
cd $(dirname $0)
gcc -Wall -Werror -Wextra main1.c get_next_line.c get_next_line.h || (echo COMPILATION FAILED && exit 1)
echo ">>>>>>>>>>> Read main1.c"
...
gcc -Wall -Werror -Wextra main2.c get_next_line.c get_next_line.h 
